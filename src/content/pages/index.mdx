...
<Image algin="left" src={stel}  width="300" quality="max" style="max-width:200px; float:left; margin-right:20px" alt="Portrait of Stefan Ellmauthaler" loading="eager" />
...
[Jugger](https://jugger.org) is my second active sport, which I try to do at least weekly.
...
Alpine skiing is some occassional hobby of mine. It happens during the winter season at holidays in Austria.
